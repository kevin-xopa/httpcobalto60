...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: 'description',
          content: 'Guía técnica de códigos HTTP con contexto real mexicano. Ejemplos en JavaScript, Python, Laravel, Rust y C++. Buenas prácticas y filosofía de respuestas HTTP.',
        },
  ...
  site: {
    ...
    description: 'Guía técnica de códigos HTTP con contexto real mexicano. Ejemplos en JavaScript, Python, Laravel, Rust y C++.',
    defaultLocale: 'es-MX',
  },
